...
const { createEnrollmentFromPayment } = require("../controllers/enrollmentController");
...
router.post('/verify-enroll', protect, restrictTo('student'), verifyAndCreateEnrollment);

// backend/routes/payment.js - Verify you have this route


// backend/routes/enrollments.js - And this route exists
router.post('/payment/enroll', protect, restrictTo('student'), createEnrollmentFromPayment);
